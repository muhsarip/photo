...
<div class="box">
	<div class="box-header with-border">
		...
		<div class="box-tools text-right">
			<span class="box-title pull-left"><i class="fa fa-table"></i> <?php echo $subject ?></span>
            <!-- <button class="btn btn-box-tool btn-xs" data-widget="collapse"><i class="fa fa-minus"></i></button> -->
			<button class="btn btn-box-tool btn-xs" id="mini-refresh"><i class='fa fa-refresh'></i></button>
		</div>
	</div>
    <div class="box-body">
		<div class="flexigrid" data-unique-hash="<?php echo $unique_hash; ?>">
			...
			<div class="tDiv row">
				<div class="tDiv2 col-xs-6 col-lg-6">
					<?php if(!$unset_add){?>
					<!-- Button ADD  -->
			        	<a href='<?php echo $add_url?>' title='<?php echo $this->l('list_add'); ?> <?php echo $subject?>' class='add-anchor add_button btn btn-primary btn-fill'>
				...
				<div class="tDiv3 col-xs-6 col-lg-6 text-right">
					<div class="btn-group">
					<?php if(!$unset_export) { ?>
					<!-- Button Export  -->
			        	<a class="export-anchor btn btn-info btn-fill" data-url="<?php echo $export_url; ?>" target="_blank">
					...
					<?php } ?>
					<?php if(!$unset_print) { ?>
			        	<a class="print-anchor btn btn-info btn-fill" data-url="<?php echo $print_url; ?>">
