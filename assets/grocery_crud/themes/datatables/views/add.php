...
<div class="flexigrid crud-form box" data-unique-hash="<?php echo $unique_hash; ?>">
	<div class="box-header with-border text-center">
		<strong class="box-title"><i class="fa fa-plus-circle fa-fw"></i> <?php echo $this->l('form_add'); ?> <?php echo $subject?> </strong>
	</div>
	...
	<div id='main-table-box' class="box-body">
		...
		<div class="text-center">
			<button type="submit" id="form-button-save" class="btn btn-primary btn-fill"><?php echo $this->l('form_save'); ?></button>
			<?php 	if(!$this->unset_back_to_list) { ?>
			
			<button type="button" id="save-and-go-back-button" class="btn btn-info btn-fill"><?php echo $this->l('form_save_and_go_back'); ?></button>
			<button type="button" id="cancel-button" class="btn btn-default btn-fill"><?php echo $this->l('form_cancel'); ?></button>
