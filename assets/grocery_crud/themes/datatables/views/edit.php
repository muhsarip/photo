...
<div class="flexigrid crud-form box" style='width: 100%;' data-unique-hash="<?php echo $unique_hash; ?>">
	<div class="box-header with-border text-center">
		<strong class="box-title"><i class="fa fa-pencil fa-fw"></i> <?php echo $this->l('form_edit'); ?> <?php echo $subject?></strong>
	</div>
	<div id='main-table-box' class="box-body">
		...
		<div class="text-center">
			<button  id="form-button-save" type='submit' class="btn btn-primary btn-fill"/><?php echo $this->l('form_update_changes'); ?></button>
			<?php 	if(!$this->unset_back_to_list) { ?>
			<button type='button' id="save-and-go-back-button" class="btn btn-info btn-fill"/><?php echo $this->l('form_update_and_go_back'); ?></button>
			<button type='button' class="btn btn-default btn-fill" id="cancel-button" /><?php echo $this->l('form_cancel'); ?></button>
			<?php 	} ?>
		</div>
		<br>
